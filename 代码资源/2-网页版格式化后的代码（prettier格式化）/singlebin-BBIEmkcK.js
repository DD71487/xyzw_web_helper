...
import { P as X, U as Y } from "./index-BdRnBi5N.js";
import { C as Z } from "./CloudUpload-DBucip-_.js";
import { L as ee, a as oe } from "./index-CgWPhAzx.js";
    ...
    setup(se, { emit: C }) {
      const w = C,
        ...
        A = (n) => {
          ...
          return (
            console.log(e),
            e
              ? ((r.name = `${e[1]}_${e[2]}_${e[4]}`), { server: e[1], roleIndex: e[2], roleId: e[3], roleName: e[4] })
          ...
          V.add(async () => {
            ...
            ((d.onload = async (v) => {
              ...
              const p = (x = v.target) == null ? void 0 : x.result,
                a = K(p),
                g = await O(p),
                N = e.roleName || ((B = n.name.split(".")) == null ? void 0 : B[0]) || "";
              if (!(await $(a, p))) {
              ...
              (m.gameTokens.find((b) => b.id === a) && u.warning(`角色"${N}"已存在，将更新该角色的Token`),
        ...
        M = async () => {
          ...
          (i.value.forEach((n) => {
            ...
            e ? (console.log("移除同名token:", e), m.updateToken(e.id, { ...n })) : m.addToken({ ...n });
          }),
      ...
      return (n, e) => {
        ...
        return (
          ...
          T(
            o(R),
            { model: r, "label-placement": "top", size: "large", "show-label": !0 },
            {
              default: l(() => [
                s("div", ae, [
                  t(
                    o(y),
                    { type: "primary", size: "large", block: "", loading: L.value, onClick: M },
                    {
                      icon: l(() => [t(o(q), null, { default: l(() => [t(o(Z))]), _: 1 })]),
                  ...
                  { label: "游戏角色名称", "show-label": !0 },
                  {
                    default: l(() => [
                      t(
                        ...
                        {
                          value: r.name,
                          "onUpdate:value": e[0] || (e[0] = (a) => (r.name = a)),
                          placeholder: "例如：主号战士",
                          clearable: "",
                        },
                        null,
                        ...
                        (a, g) => (
                          ...
                          T(
                            ...
                            { key: g },
                            {
                              default: l(() => [
                                s("div", null, [
                                  e[5] || (e[5] = s("strong", null, "角色名称:", -1)),
                                  c(" " + I(a.name || "未命名角色"), 1),
                                  e[6] || (e[6] = s("br", null, null, -1)),
                                  e[7] || (e[7] = s("strong", null, "Token:", -1)),
                                  s("span", te, I(a.token), 1),
                                  e[8] || (e[8] = s("br", null, null, -1)),
                                  e[9] || (e[9] = s("strong", null, "服务器:", -1)),
                                  c(" " + I(a.server || "未指定"), 1),
                                ]),
                              ]),
                              _: 2,
                              ...
                              { label: "服务器" },
                              {
                                default: l(() => [
                                  t(
                                    ...
                                    {
                                      value: r.server,
                                      "onUpdate:value": e[1] || (e[1] = (a) => (r.server = a)),
                                      placeholder: "服务器名称",
                                    },
                                    null,
                                    8,
                              ...
                              { label: "自定义连接地址" },
                              {
                                default: l(() => [
                                  t(
                                    ...
                                    {
                                      value: r.wsUrl,
                                      "onUpdate:value": e[2] || (e[2] = (a) => (r.wsUrl = a)),
