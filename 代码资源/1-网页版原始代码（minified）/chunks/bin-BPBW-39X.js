import { _ as J } from "./ServerRoleList-J82O2iip.js";
import {
  k as P,
  q,
  x as H,
...
import { P as ae, U as le } from "./index-BdRnBi5N.js";
import { C as ie } from "./CloudUpload-DBucip-_.js";
import { L as de, a as ue } from "./index-CgWPhAzx.js";
...
const me = { class: "form-actions" },
  pe = { style: { display: "flex", "justify-content": "space-between", "align-items": "center", width: "100%" } },
  ...
  ge = P({
    ...
    setup(fe, { emit: $ }) {
      const D = $,
        ...
        l = W(),
        z = f(!1),
        b = X({ name: "", server: "", wsUrl: "", importMethod: "", nameTemplate: "{name}-{index}-{id}" }),
        p = f([]),
        y = f([]),
        A = f(null),
        L = f(""),
        ...
        O = (t) => {
          ...
          try {
            ...
            let o = Number(t.serverId),
              r = 0;
            o >= 2e6 ? ((r = 2), (o -= 2e6)) : o >= 1e6 && ((r = 1), (o -= 1e6));
        ...
        V = async (t) => {
          ...
          try {
            ...
            if (!(await R(o, a))) throw new Error("保存BIN数据到IndexedDB失败，请检查浏览器存储空间或权限");
            let u = Number(t.serverId),
              v = 0;
            u >= 2e6 ? ((v = 2), (u -= 2e6)) : u >= 1e6 && ((v = 1), (u -= 1e6));
            const S = u - 27,
            ...
            (console.error("添加角色失败", e), l.error("添加角色失败: " + e.message));
          }
        },
        E = (t) => (
          j.add(async () => {
            ...
            ((e.onload = async (a) => {
              ...
              try {
                const s = await se(o),
                  n = JSON.parse(s);
                (n && typeof n == "object"
                  ? (y.value = Object.values(n).sort((u, v) => v.power - u.power))
                  : (y.value = []),
              ...
              try {
                const s = x.parse(o);
                let n = s.getData();
                (!n && s._raw && (console.log("Bin文件 getData() 为空，尝试使用 _raw"), (n = { ...s._raw })),
                  console.log("Bin文件解析:", n),
                  (L.value = JSON.stringify(n, null, 2)),
                  (w.value = n));
              } catch (s) {
                (console.error("Bin文件解析失败", s), (L.value = "Bin文件解析失败: " + (s.message || s)));
              }
            }),
              (e.onerror = () => {
                l.error("读取文件失败，请重试");
        ...
        M = async () => {
          ...
          (p.value.forEach((t) => {
            ...
            e ? (console.log("移除同名token:", e), k.updateToken(e.id, { ...t })) : k.addToken({ ...t });
          }),
        ...
        Q = (t, e) => {
          const a = new Blob([new Uint8Array(e)], { type: "application/octet-stream" }),
      ...
      return (t, e) => {
        ...
        return (
          ...
          I(
            c(G),
            { model: b, "label-placement": "top", size: "large", "show-label": !0 },
            {
              default: i(() => [
                d("div", me, [
                  m(
                    c(N),
                    { type: "primary", size: "large", block: "", loading: z.value, onClick: M },
                    {
                      icon: i(() => [m(c(Y), null, { default: i(() => [m(c(ie))]), _: 1 })]),
                ...
                m(
                  ...
                  { label: "角色命名格式", "show-label": !0 },
                  {
                    feedback: i(() => [
                      ...(e[3] ||
                        (e[3] = [g(" 支持变量: {name}角色名, {id}角色ID, {index}角色序号, {server}区服 ", -1)])),
                    ]),
                    default: i(() => [
                      m(
                        c(Z),
                        {
                          ...
                          "onUpdate:value": e[0] || (e[0] = (n) => (b.nameTemplate = n)),
                ...
                m(o, { data: y.value, "max-height": "50vh", onAdd: V, onDownload: O }, null, 8, ["data"]),
                m(s, null, {
                  default: i(() => [
                    (_(!0),
                    ee(
                          ...
                          I(
                            ...
                            { key: u },
                            {
                              default: i(() => [
                                d("div", pe, [
                                  d("div", null, [
                                    e[4] || (e[4] = d("strong", null, "角色名称:", -1)),
                                    g(" " + T(n.name || "未命名角色"), 1),
                                    e[5] || (e[5] = d("br", null, null, -1)),
                                    e[6] || (e[6] = d("strong", null, "Token:", -1)),
                                    d("span", ve, T(n.token), 1),
                                    e[7] || (e[7] = d("br", null, null, -1)),
                                    e[8] || (e[8] = d("strong", null, "服务器:", -1)),
                                    g(" " + T(n.server || "未指定"), 1),
                                    e[9] || (e[9] = d("br", null, null, -1)),
                                    e[10] || (e[10] = d("strong", null, "角色序号:", -1)),
                                    g(" " + T(n.roleIndex), 1),
                                  ]),
                                  m(
                                    c(N),
                                    { type: "error", size: "small", onClick: (v) => h(u) },
                                    { default: i(() => [...(e[11] || (e[11] = [g(" 删除 ", -1)]))]), _: 1 },
                                    8,
                                    ["onClick"],
                                  ),
                                ]),
