...
import { S as W } from "./Search-D4B4lpJB.js";
  ...
  le = $({
    ...
    setup(u, { emit: R }) {
      ...
      const S = g(() => {
        ...
        T = g(() => (a.maxHeight ? { maxHeight: a.maxHeight, overflowY: "auto", overflowX: "hidden" } : {}));
      function B(e) {
        var n;
        function t(i) {
        ...
        const l = (n = e.closest) == null ? void 0 : n.call(e, "[class*='modal-body' i], [class*='modal-content' i]");
        ...
        for (; r; ) {
          ...
          if (r.scrollHeight > r.clientHeight && (c === "auto" || c === "scroll" || c === "overlay")) {
            t(r);
            return;
          }
          r = r.parentElement;
        ...
        },
        {
          ...
          render(e) {
            return k("div", { style: "display: flex; gap: 8px;" }, [
              k(v, { size: "small", type: "primary", onClick: () => m("add", e) }, { default: () => "添加" }),
              k(v, { size: "small", type: "info", onClick: () => m("download", e) }, { default: () => "下载" }),
            ]);
          },
        },
      ]);
                    ...
                    default: p(() => [
                      s("div", G, [
                        d(
                          ...
                          {
                            value: y.value,
                            "onUpdate:value": t[0] || (t[0] = (l) => (y.value = l)),
                            placeholder: "搜索区服（输入区服号，如 1）",
                            clearable: "",
                            size: "small",
                            class: "server-role-list-search__input",
                          },
                          { prefix: p(() => [d(o(A), { component: o(H) }, null, 8, ["component"])]), _: 1 },
                          8,
                          ["value"],
                        ),
                      ]),
                      s("div", J, [
                        ...
                        I(
                          ...
                          q(
                            ...
                            (l, r) => (
                              f(),
                              I("div", { key: `${l.serverId}-${l.roleId}-${r}`, class: "server-role-card" }, [
                                s("div", O, [
                                  s("div", Z, _(l.name || "未命名"), 1),
                                  s("div", P, [
                                    s("span", null, _(h(l)) + "服", 1),
                                    s("span", null, "序号" + _(C(l)), 1),
                                    s("span", null, "战力 " + _(o(w)(l.power)), 1),
                                  ]),
                                ]),
                                s("div", ee, [
                                  d(
                                    o(v),
                                    { type: "primary", size: "small", block: "", onClick: (n) => m("add", l) },
                                    { default: p(() => [...(t[1] || (t[1] = [N(" 添加 ", -1)]))]), _: 1 },
                                    8,
                                    ["onClick"],
                                  ),
                                  d(
                                    o(v),
                                    { type: "info", size: "small", block: "", onClick: (n) => m("download", l) },
                                    { default: p(() => [...(t[2] || (t[2] = [N(" 下载 ", -1)]))]), _: 1 },
                                    8,
                                    ["onClick"],
                                  ),
                                ]),
                      ...
                      s("div", te, [
                        s(
                          "div",
                          { class: "server-role-list-scroll", style: K(T.value) },
                          [
                            d(
                              o(Q),
                              { columns: z.value, data: S.value, pagination: { pageSize: 5 }, "scroll-x": 600 },
                              null,
                              8,
                              ["columns", "data"],
                            ),
